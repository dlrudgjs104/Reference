...
public class TestRational2 {
    ...
    void testSubtract(Rational r1, Rational r2, Rational result) {
        assertDoesNotThrow(() -> {
            assertEquals(result, Rational.subtraction(r1, r2));
        });
    }
    ...
    void testMultiply(Rational r1, Rational r2, Rational result) {
        assertDoesNotThrow(() -> {
            assertEquals(result, Rational.multiplication(r1, r2));
        });
    }
    ...
    void testDivide(Rational r1, Rational r2, Rational result) {
        assertDoesNotThrow(() -> {
            assertEquals(result, Rational.division(r1, r2));
        });
    }
    ...
    void testOpposite(int numbrator, int denominator, int targetNumerator, int targetDenominator) {
        Rational r = new Rational(numbrator, denominator).oppsite();
